...
private enum CSVColumn: CaseIterable {
    ...
    private static let aliases: [CSVColumn: Set<String>] = [
        ...
        .fullStopDayLandings: ["dayfsldg", "fullstopday", "daylandingsfullstop", "fsday", "fullstopdaylandings", "daylandingfullstop", "dayfs", "dayfullstop"],
        .fullStopNightLandings: ["nightfs", "nightfsldg", "fullstopnight", "nightlandingsfullstop", "fullstopnightlandings", "nightlandingfullstop", "fsnight", "nightfullstop"],
        .holds: ["holds", "holding", "hold", "holdings", "instrumenthold"],
        .approaches: ["approaches", "approachcount", "instapproaches", "approach", "instrumentapproaches", "numapproaches", "approachesflown"],
