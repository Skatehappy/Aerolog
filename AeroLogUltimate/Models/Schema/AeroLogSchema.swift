...
enum AeroLogSchema {
    ...
    /// 1.4.0: additive PilotProfile fields — medicalMode, basicMedExamDate,
    /// flightReviewSource, ipcSource (all defaulted → lightweight migration).
    static let versionIdentifier = "1.4.0"
